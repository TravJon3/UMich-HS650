...
Based upon both the full and objective dataset, it appears that the factor with the biggest impact on PositiveChange is whether the participant is either the head or wife of the household.  The following are the intersection between the two datasets sorted by lift.
