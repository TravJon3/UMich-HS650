...
# dfChild02_11vars <- read_dta("/Users/Kevin/Downloads/From Adolescence to Adulthood - Are Americas Young Adults Flourishing/Cleaning-and-merging/child02-11vars.dta", encoding = "latin1")
# dfCleanMainPCGFile <- read_dta("/Users/Kevin/Downloads/From Adolescence to Adulthood - Are Americas Young Adults Flourishing/Cleaning-and-merging/cleanmain+pcgfile.dta", encoding = "latin1")
# dfIDMergFilePCG <- read_dta("/Users/Kevin/Downloads/From Adolescence to Adulthood - Are Americas Young Adults Flourishing/Cleaning-and-merging/idmergefile-pcg.dta", encoding = "latin1")
ncol(df)
nrow(df)
...
for(i in 1:ncol(df)) {
  ...
  if(is.null(attributes(df[[i]])$format.stata) == F)
    vectFormat[i] <- lapply(attributes(df[[i]])$format.stata, convertStatDataType)
