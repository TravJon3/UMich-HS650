...
filter_remove_addon <- c("change", "mhstatus", "flscale_02", "cdsiiresult", "CHLDREL",
                   "stratum", "cluster", "weight", "ER33601", "ER33602", "ER34001", "ER34002","TA090001", "ER47301", "ER34101", "ER34102", "TA110001", "TA110007", "TA110009", "Q23IWMTH", "Q23IWDAY", "Q23IWYR", "Q24MONTH", "Q24YEAR")
...
#### Functions
##untested
vector_fieldname_to_description <- function(vector_fieldname) {
  vect_labels <- attributes(tbl_dta[vector_fieldname])$labels
  replace(vector_fieldname, vector_fieldname[vector_fieldname] == vect_labels, names(vect_labels))
}


# fieldname_to_description <- function(fieldname) {
#   namedvalue <- attributes(tbl_dta[fieldname])$labels
#   replace(fieldname, fieldname == namedvalue, trimws(names(namedvalue)))
# }

fieldname_to_description <- function(colname) {
  return(attr(tbl_dta[[colname]], "label"))
}
